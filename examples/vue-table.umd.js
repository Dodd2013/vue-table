...
var vueTablePagination = { render: function render() {
    ...
    computed: {
        ...
        pages: function pages() {
            return lodash.range(1, this.pageCount + 1);
        },
...
function getClientPaginationData() {
    return lodash.slice(this.rowData, this.clientParams.pagination.offset, this.clientParams.pagination.offset + this.pagination.size);
}
...
function initData() {
    this.opt = lodash.merge({}, defaultOpt, this.options);
    this.style = lodash.merge(this.opt.styleType ? style[this.opt.styleType] : {}, this.opt.style);
